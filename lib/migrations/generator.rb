module MotionData
  class Base
    include MotionData::Migrations::Entity
    include MotionData::Migrations::Parser
    include MotionData::Migrations::Property
    include MotionData::Migrations::Relationship
  end
        ...
        def build
          ...
          builder = Nokogiri::XML::Builder.new(:encoding => "UTF-8") do |xml|
            xml.model(database_model_attributes) do
              ObjectSpace.each_object(Class).select { |klass| klass < MotionData::Base }.each do |entity|
